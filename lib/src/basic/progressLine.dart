...
class JSLinearProgress extends StatefulWidget {
  /// 百分比 0-1之间
  ...
  @override
  _JSLinearProgressState createState() => _JSLinearProgressState();
}

class _JSLinearProgressState extends State<JSLinearProgress> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  void _checkIfNeedCancelAnimation(JSLinearProgress oldWidget) {
  ...
  @override
  void didUpdateWidget(JSLinearProgress oldWidget) {
