...
class JSExpandText extends StatefulWidget {
  /// 显示的文本
  final String text;
  ...
  _JSExpandTextState createState() => _JSExpandTextState();
}

class _JSExpandTextState extends State<JSExpandText> {
  /// 是否展开
          ...
          child: GestureDetector(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                colors: [Colors.white.withAlpha(10), Colors.white.withAlpha(500), Colors.white],
