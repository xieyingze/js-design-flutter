...
class JSCircularProgress extends StatefulWidget {
  ...
  @override
  _JSCircularProgressState createState() => _JSCircularProgressState();
}

class _JSCircularProgressState extends State<JSCircularProgress> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  ...
  void _checkIfNeedCancelAnimation(JSCircularProgress oldWidget) {
  ...
  @override
  void didUpdateWidget(JSCircularProgress oldWidget) {
