...
abstract class PickerAdapter<T> {
  ...
  Widget makeText(Widget? child, String? text, bool isSel) {
    return Center(
        child: DefaultTextStyle(
            ...
            style: picker!.textStyle ?? TextStyle(color: Colors.black87, fontFamily: picker?.state?.context != null ? Theme.of(picker!.state!.context).textTheme.headline6!.fontFamily : "", fontSize: JSPicker.DefaultTextSize),
            child: child != null
  ...
  Widget makeTextEx(Widget? child, String text, Widget? postfix, Widget? suffix, bool isSel) {
    ...
    double? _txtSize = JSPicker.DefaultTextSize;
        ...
        case 4:
          if (minuteInterval == null || minuteInterval! < 2) {
            ...
            if (m != value!.minute) {
              ...
              value = DateTime(value!.year, value!.month, value!.day, value!.hour, m, s);
            }
          }
          break;
        case 5:
