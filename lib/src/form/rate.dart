...
class JSRate extends StatefulWidget {
  ...
  @override
  _JSRateState createState() => _JSRateState();
}

class _JSRateState extends State<JSRate> {
        ...
        : kIsWeb
            ? MouseRegion(
                ...
                onHover: (event) {
                  ...
                  var newRating = widget.allowHalfRating ? _rate : _rate.ceil().toDouble();
            ...
            : GestureDetector(
                onTapDown: (detail) {
                  ...
                  var newRating = widget.allowHalfRating ? i : i.ceil().toDouble();
