...
class JSImagePreviewer extends StatefulWidget {
  final List<String> images;
  final int index;
  final Function? onDismissCallBack;
  JSImagePreviewer({Key? key, required this.images, this.index = 0, this.onDismissCallBack}) : super(key: key);

  @override
  _JSImagePreviewerState createState() => _JSImagePreviewerState();
...
class _JSImagePreviewerState extends State<JSImagePreviewer> {
  /// page管理
                ...
                child: Container(
                  ...
                  child: SmoothPageIndicator(
                    ...
                    effect: WormEffect(
                      ...
                      dotWidth: 9,
                      type: WormType.thin,
                      dotColor: themeColors.white(alpha: 0.5),
