        ...
        return Positioned(
          ...
          child: GestureDetector(
            ...
            onPanEnd: (DragEndDetails detail) {
              if (moveOffset.dx > 56 && moveOffset.dx < (JSScreen.width / 2)) {
                moveOffset = Offset(0, moveOffset.dy);
              }
              if (moveOffset.dx > JSScreen.width / 2 && moveOffset.dx < (JSScreen.width)) {
                moveOffset = Offset(JSScreen.width, moveOffset.dy);
              }
              setState(() {
