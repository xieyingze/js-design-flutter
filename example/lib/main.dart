...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    /// 主题初始化
    JSThemeManager.instance.init(colors: JDColor()); 
        ...
        switch (snapshot.connectionState) {
          case ConnectionState.done:
            ...
            return ResponsiveWrapper.builder(
              ...
              background: Container(color: themeColors.card()),
            );
          default:
            return Scaffold(
              body: Center(
  ...
  Widget _getDefaultWidget(BuildContext context) {
    double screenWidth = JSScreen.getWidth(context);
    JSScreen.instance.screenWidth = screenWidth;
