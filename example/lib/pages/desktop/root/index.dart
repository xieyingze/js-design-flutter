...
import 'package:js_design_kit_example/pages/desktop/header/index.dart';
import 'package:js_design_kit_example/pages/desktop/home/index.dart';
    ...
    return BaseScaffold(
      child: Row(
        children: [
          ...
          Container(
            width: JSScreen.getWidth(context) - 60,
            child: Obx(
              () => Stack(
                children: _widgets
                    .asMap()
