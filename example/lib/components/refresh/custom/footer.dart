...
import 'package:js_design_kit_example/components/refresh/refresh/easy_refresh.dart';
...
class MBCustomFooter extends Footer {
  ...
  @override
  Widget contentBuilder(BuildContext context, LoadMode loadState, double pulledExtent, double loadTriggerPullDistance, double loadIndicatorExtent, AxisDirection axisDirection, bool float, Duration? completeDuration, bool enableInfiniteLoad,
